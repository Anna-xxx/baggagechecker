...
const CARRYON_BASE: { name: string; code: string; h: number; w: number; d: number; kg: number }[] = [
  ...
  { name: 'ITA Airways', code: 'AZ', h: 55, w: 40, d: 23, kg: 8 },
  ...
  { name: 'Malaysia Airlines', code: 'MH', h: 56, w: 36, d: 23, kg: 7 },
  ...
  { name: 'TAP Air Portugal', code: 'TP', h: 55, w: 40, d: 25, kg: 10 },
  { name: 'Thai Airways', code: 'TG', h: 56, w: 45, d: 25, kg: 7 },
  { name: 'Turkish Airlines', code: 'TK', h: 55, w: 40, d: 23, kg: 8 },
  { name: 'Uzbekistan Airways', code: 'HY', h: 55, w: 35, d: 25, kg: 8 },
  { name: 'Virgin Atlantic', code: 'VS', h: 56, w: 36, d: 23, kg: 10 },
  { name: 'Virgin Australia', code: 'VA', h: 56, w: 36, d: 23, kg: 8 },
