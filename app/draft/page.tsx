...
const MEASURE_STEPS = [
  ...
  'Measure width at the widest point, including side handles or straps if they protrude.',
  'Measure depth front to back, including packed external pockets and expanded sections.',
  'Weigh the packed bag and compare the result with your airline allowance.',
];
