...
export const AIRLINES: Airline[] = [
  ...
  },
  {
    ...
    baggageUrl: 'https://www.airnewzealand.com/carry-on-baggage',
    carryOn: { w: 40, h: 55, d: 23, kg: 7, linearCm: 118, verified: true, note: 'On the smaller Q300 aircraft the depth of the bag may not exceed 22 cm.' },
    carryOnVariants: [
      { id: 'economy', label: 'Economy · 1 bag · 7 kg', w: 40, h: 55, d: 23, kg: 7, linearCm: 118, verified: true },
      { id: 'premium-business', label: 'Premium Economy / Business Premier · 2 bags · 14 kg total', w: 40, h: 55, d: 23, kg: 14, maxSingleKg: 10, linearCm: 118, weightRule: 'combinedWithPersonal', note: 'Two carry-on bags share a 14 kg total limit and no single bag may exceed 10 kg. Koru and Star Alliance Gold members get the same two-bag allowance.', verified: true },
    ],
    personal: { rule: 'fitUnderSeat', kg: 0, verified: true },
    checked: { kg: 23, total: 158, eco: 23, biz: 23, bags: 'Fare and route dependent; Seat+Bag and most international fares include 1 bag, more in Premium Economy and Business Premier', verified: true, rule: 'linear', note: 'Every checked bag is 23 kg and 158 cm total, in all cabins — higher cabins add bags rather than weight. A bag over 23 kg is accepted up to 32 kg for an excess fee.' },
    classAllowances: [
      { name: 'Economy (Seat / Seat+Bag / Flexi)', carryOn: '1 bag · 7 kg + 1 small item', checkedBags: 'Seat: 0 · Seat+Bag and most international fares: 1', weightPerBag: '23 kg', verified: true },
      { name: 'Premium Economy', carryOn: '2 bags · 14 kg total + 1 small item', checkedBags: 'More than Economy; varies by route', weightPerBag: '23 kg', verified: true },
      { name: 'Business Premier', carryOn: '2 bags · 14 kg total + 1 small item', checkedBags: 'More than Economy; varies by route', weightPerBag: '23 kg', note: 'No single carry-on bag may exceed 10 kg.', verified: true },
    ],
  },
  {
    ...
    baggageUrl: 'https://www.alaskaair.com/content/travel-info/baggage/carry-on-luggage',
    carryOn: { w: 36, h: 56, d: 23, kg: 0, verified: true, note: 'Alaska publishes no weight limit for carry-on baggage — 22 × 14 × 9 in, including wheels and handles.' },
    personal: { rule: 'fitUnderSeat', kg: 0, verified: true },
    checked: { kg: 23, total: 158, eco: 23, biz: 23, bags: 'Fees apply on most fares; the free allowance depends on fare, status and card', verified: true, rule: 'linear', note: 'Each bag may be up to 62 linear inches (158 cm total) and 50 lb (23 kg), in every cabin. Heavier or larger bags are accepted for an additional fee.' },
    classAllowances: [
      { name: 'Saver / Main', carryOn: '1 carry-on + 1 personal item', checkedBags: 'Paid on most fares', weightPerBag: '23 kg', verified: true },
      { name: 'Premium Class', carryOn: '1 carry-on + 1 personal item', checkedBags: 'Paid on most fares', weightPerBag: '23 kg', verified: true },
      { name: 'First Class', carryOn: '1 carry-on + 1 personal item', checkedBags: 'Free bags included', weightPerBag: '23 kg', verified: true },
    ],
  },
  {
    name: 'ITA Airways',
  ...
  },
  {
    ...
    carryOn: { w: 40, h: 55, d: 25, kg: 10, verified: true, linearCm: 115, manualCheck: true, weightRule: 'combinedWithPersonal', note: 'Carry-on + personal item: 10 kg combined. Smaller aircraft may have stricter size limits.' },
  ...
  },
  {
    ...
    baggageUrl: 'https://www.spirit.com/optional-services',
    carryOn: { w: 46, h: 56, d: 25, kg: 0, verified: true, note: '22 × 18 × 10 in including handles and wheels. Spirit publishes no carry-on weight limit, but a carry-on is not part of the base fare.' },
    carryOnVariants: [
      { id: 'base', label: 'Base fare · personal item only', kg: 0, allowed: false, note: 'The cheapest fare includes only the free personal item; a carry-on bag can be bought separately, and is cheapest before the airport.', verified: true },
      { id: 'bundle', label: 'Fare bundle including a carry-on', w: 46, h: 56, d: 25, kg: 0, verified: true },
    ],
    personal: { rule: 'dimensions', w: 35, h: 45, d: 20, kg: 0, verified: true },
    checked: { kg: 23, total: 158, eco: 23, biz: 23, bags: 'Every checked bag is paid unless the fare bundle includes one; the price depends on when it is bought', verified: true, rule: 'linear', note: 'Maximum 62 linear inches (158 cm total) and 50 lb (22.6 kg). Heavier or larger bags are accepted for additional fees.' },
    classAllowances: [
      { name: 'Base fare', carryOn: 'Personal item only · 18 × 14 × 8 in', checkedBags: 'Paid', weightPerBag: '23 kg', verified: true },
      { name: 'Fare bundles', carryOn: '1 carry-on + 1 personal item', checkedBags: 'Some bundles include the first bag', weightPerBag: '23 kg', verified: true },
    ],
  },
  {
